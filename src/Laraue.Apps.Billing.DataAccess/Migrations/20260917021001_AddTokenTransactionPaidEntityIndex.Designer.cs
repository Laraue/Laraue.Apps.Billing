...
namespace Laraue.Apps.Billing.DataAccess.Migrations
{
    ...
    [Migration("20260917021001_AddTokenTransactionPaidEntityIndex")]
    partial class AddTokenTransactionPaidEntityIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Laraue.Apps.Billing.DataAccess.Entities.BalanceSubscriptionToken", b =>
                {
                    ...
                    b.Property<DateOnly?>("LastDailyGrantAt")
                        .HasColumnType("date")
                        .HasColumnName("last_daily_grant_at");
            ...
            modelBuilder.Entity("Laraue.Apps.Billing.DataAccess.Entities.TokenTransaction", b =>
                {
                    ...
                    b.HasIndex("PaidEntityId", "CreatedAt", "Id")
                        .IsDescending(false, true, true)
                        .HasDatabaseName("ix_token_transactions_paid_entity_id_created_at_id");
